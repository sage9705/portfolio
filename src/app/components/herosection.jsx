    ...
    <section className="lg:py-16">
      <div className="container flex flex-col sm:flex-row items-center">
        ...
        >
          ...
          <div>
            <p className="text-[#e0e0e0] text-base sm:text-lg mb-6 lg:text-xl">
          ...
          <div>
            <Link
              href="/#contact"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-[#4ce6de] hover:bg-[#003049] hover:text-white text-[#0e0e0e]"
            >
              Hire Me
            </Link>
            <Link
              href="/"
              className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-[#4ce6de] hover:bg-[#003049] text-white mt-3"
            >
